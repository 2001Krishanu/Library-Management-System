...
$data=mysqli_query($con, "SELECT * FROM `students_reg` WHERE `email` = '$student_login' OR `username` = '$student_login'");
        ...
        <div class="rightside-header">
            ...
            <div class="header-section" id="user-headerbox">
                <div class="user-header-wrap">
                    ...
                    <div class="user-info">
                        <?php
                        $username=$_SESSION['student_login']

                        ?>
                        <span class="user-name"><?= ucwords($student_info['fname']) ?></span>
